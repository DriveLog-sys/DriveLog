...
const CATS = [
  ...
  { name:'Sports Car',   fa:'fas fa-car',               desc:'High-performance sports machines',               color:'#a855f7', badge:'badge-sports'     },
  { name:'GT',           fa:'fas fa-road',              desc:'Grand tourers built for distance and speed',     color:'#6366f1', badge:'badge-gt'         },
  ...
  { name:'Vintage',      fa:'fas fa-history',           desc:'Pre-1970s icons and veteran automobiles',        color:'#b45309', badge:'badge-vintage'    },
  { name:'Retro',        fa:'fas fa-clock',             desc:'Nostalgic builds and era-inspired machines',     color:'#d97706', badge:'badge-retro'      },
  { name:'Cult Classic', fa:'fas fa-certificate',       desc:'Niche legends with passionate followings',       color:'#7c3aed', badge:'badge-cult'       },
  { name:'Hatch',        fa:'fas fa-car-side',          desc:'Hot hatches and compact performance builds',     color:'#10b981', badge:'badge-hatch'      },
  { name:'Tuner',        fa:'fas fa-wrench',            desc:'Modified and tuned street machines',             color:'#f43f5e', badge:'badge-tuner'      },
  { name:'Luxury',       fa:'fas fa-gem',               desc:'Premium and prestige automobiles',               color:'#14b8a6', badge:'badge-luxury'     },
  { name:'Saloon',       fa:'fas fa-car',               desc:'Sedan and saloon performance builds',            color:'#64748b', badge:'badge-saloon'     },
  ...
  { name:'Utility',      fa:'fas fa-tools',             desc:'Work vehicles, vans, and utility builds',        color:'#854d0e', badge:'badge-utility'    },
  ...
  { name:'Rally',        fa:'fas fa-map-signs',         desc:'Stage rally and special stage machines',         color:'#eab308', badge:'badge-rally'      },
  ...
  { name:'Race',         fa:'fas fa-trophy',            desc:'Full race builds and competition cars',          color:'#dc2626', badge:'badge-race'       },
  { name:'Drag',         fa:'fas fa-tachometer-alt',    desc:'Straight-line machines built for the strip',    color:'#eab308', badge:'badge-drag'       },
  { name:'Collector',    fa:'fas fa-crown',             desc:'Rare, investment-grade automobiles',             color:'#f59e0b', badge:'badge-collector'  },
];
